% DO NOT put a magic command here as it messes with output directory
% build from chapters or main

% To update completions and keymaps goto /home/guillaume/.config/sublime-text-3/Packages/LaTeXTools etc...
...
\newcommand\sslashed[1]{{\mathllap{\slashed{#1}}}}
...
% \newcommand{\U}{\mathrm{U}} doesn't work
