...
\definition{
    ...
    \begin{itemize}
        ...
        \item An element $g \in G_1$ is denoted, given a pair of functions called the \textit{source} and \textit{target} $s,t: G_1 \rightrightarrows G_0$ such that $s(g) \rightarrow t(g)$. Technically, this defines the set of composable arrows $G_1 ~_s{\times}_t \:G_1$.
    \end{itemize}
}
