...
\definition{
    ...
    The anchor map induces a Lie algebra homomorphism between modules of sections $\rho_* : \Gamma(A) \rightarrow \Gamma(TM) $ by the \textit{symbol-squiggle theorem} which we will see in \ref{thm:symbol_squiggle}
    with
    \begin{equation}
        \rho_*[s,s']_E = [\rho(s), \rho(s')]_{TM}
    \end{equation}
