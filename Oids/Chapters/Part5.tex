...
\definition{
    ...
    \begin{equation}
        ...
        \end{tikzcd}
    \end{equation}
    where the projective maps $\pi^k$ sends classes of functions in the $k$-jet to the class of function that agree on a lower order derivative.
...
\definition{
    ...
    For $\phi \in \mathrm{Hom}_\mathbb{K}(\mathcal{P}, \mathcal{Q})$ and $a \in \mathcal{A}$, we define the \textit{commutator} of $\mathbb{K}$-linear morphisms
    \begin{align}
